...
//
#define WizStrPersonalKnowlageBase NSLocalizedString(@"Personal KnowlageBase", nil)
#define WizStrCancelEdit NSLocalizedString(@"Cancel Edit",nil)
#define WizStrRecord  NSLocalizedString(@"Record", nil)
#define WizStrPersonalNotes         NSLocalizedString(@"Personal Notes",nil)
...
#define WizStrUserRegister      @"UserRegister"
#define WizStrUserLogin         @"UserLogin"
#define WizStrUserSyncEnd      @"UserSyncEnd"
#define WizStrUserNew           @"WizStrUserNew"

#define WizStrVersion           @"WizStrVersion"
#define WizStrWebSharing        NSLocalizedString(@"Web Sharing",nil)
